                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            <div class="sparkline13-graph"  style="align-items: center; justify-content: center">
                                <div class="datatable-dashv1-list custom-datatable-overright" style="padding: 30px">
                                    <h1 class="text-center">Update Employee</h1>
                                    <br>
                                    <form action="{{ route('employee.update', $employee->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        @method('PUT')
                                        {{-- {{ method_field('PATCH') }} --}}
                                        @csrf
                                        <div class="form-group col-md-6">
                                          <label>Full Name</label>
                                          <input type="text" class="form-control" name="fullname" value="{{ $employee->fullname }}" placeholder="Enter your fullname">
                                          @error('fullname')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="fathername" value="{{ $employee->fathername }}" placeholder="Enter your fathername">
                                            @error('fathername')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Address</label>
                                            <input type="text" class="form-control" name="address" value="{{ $employee->address }}" placeholder="Enter your address">
                                            @error('address')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Phone</label>
                                            <input type="number" class="form-control" name="phone" value="{{ $employee->phone }}" placeholder="Enter your phone number">
                                            @error('phone')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>CNIC</label>
                                            <input type="number" class="form-control" name="cnic" value="{{ $employee->cnic }}" placeholder="Enter your cnic">
                                            @error('cnic')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="department" class="form-control">
                                                ...
                                                <option value="sweeper"
                                                 @php
                                                if($employee['department']=='sweeper'){
                                                    echo 'selected';
                                                }
                                                @endphp
                                                >Sweeper</option>
                                                <option value="wheat worker"
                                                 @php
                                                if($employee['department']=='wheat worker'){
                                                    echo 'selected';
                                                }
                                                @endphp
                                                >Wheat Worker</option>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Salary</label>
                                            <input type="number" class="form-control" name="salary" value="{{ $employee->salary }}" placeholder="Enter salary in rupees">
                                            @error('salary')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="education" value="{{ $employee->education }}" placeholder="Enter your education">
                                            @error('education')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="experience" value="{{ $employee->experience }}" placeholder="Enter your experience">
                                            @error('experience')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-6" style="padding-bottom: 20px">
                                            ...
                                            <input type="text" class="form-control" name="religion" value="{{ $employee->religion }}" placeholder="Enter your religion">
                                            @error('religion')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-6" style="padding-bottom: 20px">
                                            ...
                                            {{-- @php
                                                ...
                                                <input type="hidden" hidden value="{{ $employee['image'] }}" name="image">
                                                <img src="{{ asset('storage/app/'.$employee->image) }}" style="height: 100px; width: 100px" alt="">
                                            @error('image')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
